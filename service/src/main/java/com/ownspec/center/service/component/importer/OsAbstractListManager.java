...
/**
 * Created by nlabrot on 18/05/17.
 */
public class OsAbstractListManager {
  ...
  protected class ParagraphLevelCounter {
    ...
    public int incrementLevelRaw(int levelNumber, LevelTuple[] overrideLevelTuples) {
      ...
      counts.add(levelNumber, getStart(levelNumber, overrideLevelTuples));
      lastLevel = levelNumber;
      return getStart(levelNumber, overrideLevelTuples);
    }


    protected String getNumFormat(int level, LevelTuple[] overrideLevelTuples) {
      ...
      return getNumFormat(level, isLegal, overrideLevelTuples);
    }
    ...
    protected String getNumFormat(int lvlNum, boolean isLegal, LevelTuple[] overrideLevelTuples) {
